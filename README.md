...
This command will:
- Generate 100000 random, non-repeating five-word combinations per run (default behavior).
...
# Generate LuckyFive combinations (every 30 minutes) - processes 100000 random combinations per run
